...
import torchvision
from utils.load_data import VideoGrayScaler, MinMaxScaler
...
if __name__ == "__main__":
    ...
    predictive_model = torch.nn.DataParallel(SmallDataClassifier(frozen_sparse, False))
    ...
    transform = torchvision.transforms.Compose([VideoGrayScaler(),
                                             MinMaxScaler(0, 255),
    ...
    for i in tqdm(range(vc.num_clips())):
        ...
        with torch.no_grad():
            ...
            clip, _ = frozen_sparse(clip, u_init)

            pred, activations = predictive_model(clip)
